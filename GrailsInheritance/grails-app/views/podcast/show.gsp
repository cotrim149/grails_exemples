...
<html>
    ...
    <body>
        ...
        <div id="show-podcast" class="content scaffold-show" role="main">
            ...
            <f:display bean="podcast" />
            <g:form resource="${this.podcast}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${this.podcast}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
